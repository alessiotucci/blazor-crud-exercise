...
namespace MonusProject.Server.Migrations
{
    ...
    [Migration("20231020140913_prowdwenwork")]
    partial class prowdwenwork
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MonusProject.Client.Shared.Models.Dipendente", b =>
                {
                    b.HasOne("MonusProject.Client.Shared.Models.Sede", "SedeDipendete")
                        .WithMany("Dipendents")
                        .HasForeignKey("Sede")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("SedeDipendete");
                });
