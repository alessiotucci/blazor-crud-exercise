...
namespace MonusProject.Server.Migrations
{
    ...
    [Migration("20231020083606_add_fix_detail")]
    partial class add_fix_detail
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MonusProject.Client.Shared.Models.Dipendente", b =>
                {
                    ...
                    b.Property<int>("SedeDipendenteSedeId")
                        .HasColumnType("int");

                    b.HasKey("DipendenteId");

                    b.HasIndex("SedeDipendenteSedeId");
            ...
            modelBuilder.Entity("MonusProject.Client.Shared.Models.Dipendente", b =>
                {
                    b.HasOne("MonusProject.Client.Shared.Models.Sede", "SedeDipendente")
                        .WithMany("DipendentsSede")
                        .HasForeignKey("SedeDipendenteSedeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
